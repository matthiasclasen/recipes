...
test: test-repo
	...
	flatpak-builder --force-clean --arch=i386 --repo=test-repo --ccache --from-git=git://git.gnome.org/recipes --from-git-branch=master recipes flatpak/org.gnome.Recipes.json
	flatpak-builder --force-clean --repo=test-repo --ccache --from-git=git://git.gnome.org/recipes --from-git-branch=recipes-1.0 recipes flatpak/org.gnome.Recipes.json
	flatpak-builder --force-clean --arch=i386 --repo=test-repo --ccache --from-git=git://git.gnome.org/recipes --from-git-branch=recipes-1.0 recipes flatpak/org.gnome.Recipes.json

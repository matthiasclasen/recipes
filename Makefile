...
test: test-repo org.gnome.Recipes.flatpak.json
	flatpak-builder --force-clean --repo=test-repo --ccache --require-changes --from-git=git://git.gnome.org/recipes --from-git-branch=master recipes org.gnome.Recipes.flatpak.json
...
release: repo org.gnome.Recipes.flatpak.json
	...
	flatpak-builder --verbose --force-clean --repo=repo  --ccache --gpg-homedir=gpg --gpg-sign=${RELEASE_GPG_KEY} --from-git=git://git.gnome.org/recipes --from-git-branch=master recipes  org.gnome.Recipes.flatpak.json
